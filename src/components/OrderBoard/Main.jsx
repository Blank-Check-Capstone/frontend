...
const Main = () => {
    return <div className="w-[86%] h-full ml-[14%]">
        <div className="w-[86%] h-[10%] border-b-4 border-[#F1F1F1] bg-white fixed top-0 flex">
        ...
        <div className="w-full h-[80%]">
            <div className="w-full h-[10%] text-[25px] bg-[#D9D9D9] flex items-center p-5 mt-[10%]">
                면류
            </div>
            <div className="flex justify-center gap-5 mt-[2%]">
                <div className="h-[300px] w-[31%] bg-[#D9D9D9] flex flex-col items-center">
                    <div className="h-[60%] w-[90%] bg-white mt-[5%]"></div>
                    <div className="items-start">
                        <div className="">짜장면</div>
                        <div className="">7,000원</div>
                    </div>
                </div>
            </div>
        </div>

        <div className="w-[86%] h-[10%] border-t-4 border-[#F1F1F1] bg-white flex fixed bottom-0 items-center px-[1%] gap-3">
