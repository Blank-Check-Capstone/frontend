...
const Footer = () => {
  return (
    <div className="fixed w-[85vw] bottom-0 left-[15vw] flex h-[8vw] border-t-2 border-t-[#F1F1F1] bg-white items-center px-[1%] gap-3">
      <div className="w-[20%] h-[75%] border-[0.2vw] border-[#DBDBDB] bg-white rounded-lg flex items-center justify-center gap-2 ">
        <img
          src={gifts_image}
          alt="선물하기 사진"
      ...
      <div className="w-[20%] h-[75%] border-[0.2vw] border-[#DBDBDB] bg-white rounded-lg flex items-center justify-center gap-4 ml-auto">
        <svg
      ...
      <div className="w-[20%] h-[75%] bg-[#27CACA] rounded-lg flex items-center justify-center gap-5 ">
