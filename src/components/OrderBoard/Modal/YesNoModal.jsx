...
const YesNoModal = ({ title, content, onYesClick, onNoClick }) => {
  return (
    <div className="w-full h-full fixed flex justify-center items-center z-10">
      <div className="w-[45vw] h-[25vw] flex flex-col rounded-lg bg-white relative z-[2] justify-center items-center">
        ...
        <div className="flex gap-[1vw] h-[5vw] w-[40vw] text-[2vw] font-bold">
          <div className="bg-[#46B0AE] text-white w-[40vw] h-full hover:cursor-pointer flex justify-center items-center rounded-lg"  onClick={onYesClick}>
          ...
          <div className="bg-gray-400 text-white w-[40vw] h-full hover:cursor-pointer flex justify-center items-center rounded-lg" onClick={onNoClick}>
